...
\x1b[92;1m===================================>\x1b[92;1m
\x1b[93;1m Author        \x1b[92;1m=>      \x1b[93;1m9X HACKER
\x1b[93;1m Facebook       \x1b[92;1m=>      \x1b[93;1mRs Captain
\x1b[93;1m YouTube       \x1b[92;1m=>      \x1b[93;1mRS CAPTAIN9T9
\x1b[92;1m===================================>\x1b[92;1m
"""%(h))
...
def menu(): #Bilo
	...
	if farhan in ['1','01']:
		...
		os.system("xdg-open https://youtube.com/channel/UC9QTZEZsu-7kyxzaGq4D8Mg")
		exit()
	else:
		os.system("https://youtube.com/channel/UC9QTZEZsu-7kyxzaGq4D8Mg")
		exit()
...
def crack2(idf,pwv):
	...
	fff = '%'
	print('\r%s [9X HACKER] %s/%s  OK*%s | CP*%s => %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
		...
		try:
			...
			if "www.facebook.com" in resp.json()["error_msg"]:
				if 'ya' in oprek:
					...
					print('\r%s [9X HACKER-CP] %s|%s        '%(b,idf,pw))
...
if __name__=='__main__':
	...
	os.system("xdg-open https://www.tiktok.com/@rs.captain9t9?_t=8WEER3wjGLK&_r=1")
	menu()
